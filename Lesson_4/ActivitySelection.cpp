...
// is the least among the remaining activities and the start time is more than or 
// equal to the finish time of the previously selected activity. 
// We can sort the activities according to their finishing time so that we always consider 
